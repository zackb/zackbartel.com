...
[My first attempt](https://github.com/zackb/code/tree/master/cpp/wat) used SDL2/3 and ImGui, but I didn't like the menu being a window (there's no [layer shell](https://wayland.app/protocols/wlr-layer-shell-unstable-v1) support in SDL). So I rewrote it using pure Wayland protocols and EGL for rendering.
